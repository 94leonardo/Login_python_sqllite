...
class FormLoginDesigner:
    ...
    def __init__(self):
        ...
        title = tk.Label(frame_form_top, text="Inicio de Session", font=(
        ...
        inicio = tk.Button(frame_form_fill, text="Iniciar session", font=(
            'Times', 15, BOLD), bg='#3a7ff6', bd=0, fg="#fff", command=self.verificar)
